...
() Set up comparison between first and second sale price model.
...
split_sales_model_2 <- rsample::initial_split(sales_predictions_with_additional_dataset)
...
sale_price_predictions <- 
  augment(rf_fit_sales_model_2, sales_2019_model_2)
