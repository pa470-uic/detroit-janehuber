...
#my_set %>% extract_workflow(id = "normalized_boosted")

# I'm having a lot of trouble with getting my workflow_map. I'm unable to get any model but the linear regression to work in the workflow set. However, when I apply those models on their own (without tuning parameters) to my workflow and recipes on their own, I have confirmed that they all work. Feeling stumped on this one...
...
# Conclusion & Presentation (Part C)

Final thoughts here, comparing to all of these things.
